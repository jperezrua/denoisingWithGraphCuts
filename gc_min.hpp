 ...
 *
 */
template <class TWeight> class GC_Solver
{
    public:
    GC_Solver();
    GC_Solver( unsigned int vtxCount, unsigned int edgeCount );
    ~GC_Solver();
...
GC_Solver<TWeight>::GC_Solver() {
    flow = 0;
}

template <class TWeight>
GC_Solver<TWeight>::GC_Solver( unsigned int vtxCount, unsigned int edgeCount ) {
...
template <class TWeight>
void GC_Solver<TWeight>::create( unsigned int vtxCount, unsigned int edgeCount ) {
...
template <class TWeight>
void GC_Solver<TWeight>::addEdges( int i, int j, TWeight w, TWeight revw ) {
...
template <class TWeight>
void GC_Solver<TWeight>::addTermWeights( int i, TWeight sourceW, TWeight sinkW ) {
    CV_Assert( i>=0 && i<(int)vtcs.size() );
...
template <class TWeight>
TWeight GC_Solver<TWeight>::maxFlow() {
...
template <class TWeight>
bool GC_Solver<TWeight>::inSourceSegment( int i ) {
    CV_Assert( i>=0 && i<(int)vtcs.size() );
    return vtcs[i].t == 0;
}
#endif
